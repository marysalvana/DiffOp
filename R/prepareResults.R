prepareResults_mle <- function(fittedModel,
                      ...
                      splines_degree,
                      inner_knots1, inner_knots2, nb1, nb2, est_sd = NULL){
          ...
          if(c1_fix & c2_fix){
            ...
            if(d1_fix & d2_fix){
              ...
              results <- list(convergence_code = fittedModel$code, iterations = fittedModel$iterations, loglikelihood_value = -fittedModel$minimum, theta = fittedModel$estimate, gradient = fittedModel$gradient,
                              ...
                              est_b1 = B1,
                              est_C1 = C1,
                              est_C1_sd = est_sd[1 + 1:nb1],
                              est_d1 = D1,
                              est_a2 = A2,
                              est_b2 = B2,
                              est_C2 = C2,
                              est_C2_sd = est_sd[1 + nb1 + 1:nb2],
                              est_d2 = D2,
                              splines_degree = splines_degree, inner_knots1 = inner_knots1, inner_knots2 = inner_knots2)
              ...
              results <- list(convergence_code = fittedModel$code, iterations = fittedModel$iterations, loglikelihood_value = -fittedModel$minimum, theta = fittedModel$estimate, gradient = fittedModel$gradient,
                              ...
                              est_b2 = B2,
                              est_C2 = C2,
                              est_C2_sd = est_sd[1 + nb1 + 1 + 1:nb2],
                              est_d2 = D2,
          ...
          if(c1_fix & c2_fix){
            ...
            if(d1_fix & d2_fix){
              ...
              results <- list(convergence_code = fittedModel$code, iterations = fittedModel$iterations, loglikelihood_value = -fittedModel$minimum, theta = fittedModel$estimate, gradient = fittedModel$gradient,
                              ...
                              est_C2 = C2,
                              est_C2_sd = est_sd[3 + nb1 + 2 + 1:nb2],
                              est_d2 = D2,
                              splines_degree = splines_degree, inner_knots1 = inner_knots1, inner_knots2 = inner_knots2)
              ...
              results <- list(convergence_code = fittedModel$code, iterations = fittedModel$iterations, loglikelihood_value = -fittedModel$minimum, theta = fittedModel$estimate, gradient = fittedModel$gradient,
                              ...
                              est_C2 = C2,
                              est_C2_sd = est_sd[3 + nb1 + 3 + 1:nb2],
                              est_d2 = D2,
          ...
          if(c1_fix & c2_fix){
            ...
            if(d1_fix & d2_fix){
              ...
              results <- list(convergence_code = fittedModel$code, iterations = fittedModel$iterations, loglikelihood_value = -fittedModel$minimum, theta = fittedModel$estimate, gradient = fittedModel$gradient,
                              ...
                              est_b2 = B2,
                              est_C2 = C2,
                              est_C2_sd = est_sd[3 + nb1 + 1 + 1:nb2],
                              est_d2 = D2,
          ...
          if(c1_fix & c2_fix){
            ...
            if(d1_fix & d2_fix){
              ...
              results <- list(convergence_code = fittedModel$code, iterations = fittedModel$iterations, loglikelihood_value = -fittedModel$minimum, theta = fittedModel$estimate, gradient = fittedModel$gradient,
                              ...
                              est_C2 = C2,
                              est_C2_sd = est_sd[5 + nb1 + 2 + 1:nb2],
                              est_d2 = D2,
                              splines_degree = splines_degree, inner_knots1 = inner_knots1, inner_knots2 = inner_knots2)
              ...
              results <- list(convergence_code = fittedModel$code, iterations = fittedModel$iterations, loglikelihood_value = -fittedModel$minimum, theta = fittedModel$estimate, gradient = fittedModel$gradient,
                              ...
                              est_C2 = C2,
                              est_C2_sd = est_sd[5 + nb1 + 3 + 1:nb2],
                              est_d2 = D2,
          ...
          if(c1_fix & c2_fix){
            ...
            if(d1_fix & d2_fix){
              ...
              results <- list(convergence_code = fittedModel$code, iterations = fittedModel$iterations, loglikelihood_value = -fittedModel$minimum, theta = fittedModel$estimate, gradient = fittedModel$gradient,
                              ...
                              est_b1 = B1,
                              est_C1 = C1,
                              est_C1_sd = est_sd[2 + 1:nb1],
                              est_d1 = D1,
                              est_a2 = A2,
                              est_b2 = B2,
                              est_C2 = C2,
                              est_C2_sd = est_sd[2 + nb1 + 1:nb2],
                              est_d2 = D2,
                              splines_degree = splines_degree, inner_knots1 = inner_knots1, inner_knots2 = inner_knots2)
              ...
              results <- list(convergence_code = fittedModel$code, iterations = fittedModel$iterations, loglikelihood_value = -fittedModel$minimum, theta = fittedModel$estimate, gradient = fittedModel$gradient,
                              ...
                              est_b2 = B2,
                              est_C2 = C2,
                              est_C2_sd = est_sd[2 + nb1 + 1 + 1:nb2],
                              est_d2 = D2,
          ...
          if(c1_fix & c2_fix){
            ...
            if(d1_fix & d2_fix){
              ...
              results <- list(convergence_code = fittedModel$code, iterations = fittedModel$iterations, loglikelihood_value = -fittedModel$minimum, theta = fittedModel$estimate, gradient = fittedModel$gradient,
                              ...
                              est_C2 = C2,
                              est_C2_sd = est_sd[4 + nb1 + 2 + 1:nb2],
                              est_d2 = D2,
                              splines_degree = splines_degree, inner_knots1 = inner_knots1, inner_knots2 = inner_knots2)
              ...
              results <- list(convergence_code = fittedModel$code, iterations = fittedModel$iterations, loglikelihood_value = -fittedModel$minimum, theta = fittedModel$estimate, gradient = fittedModel$gradient,
                              ...
                              est_C2 = C2,
                              est_C2_sd = est_sd[4 + nb1 + 3 + 1:nb2],
                              est_d2 = D2,
          ...
          if(c1_fix & c2_fix){
            ...
            if(d1_fix & d2_fix){
              ...
              results <- list(convergence_code = fittedModel$code, iterations = fittedModel$iterations, loglikelihood_value = -fittedModel$minimum, theta = fittedModel$estimate, gradient = fittedModel$gradient,
                              ...
                              est_b1 = B1,
                              est_C1 = C1,
                              est_C1_sd = est_sd[1:nb1],
                              est_d1 = D1,
                              est_a2 = A2,
                              est_b2 = B2,
                              est_C2 = C2,
                              est_C2_sd = est_sd[nb1 + 1:nb2],
                              est_d2 = D2,
                              splines_degree = splines_degree, inner_knots1 = inner_knots1, inner_knots2 = inner_knots2)
          ...
          if(c1_fix & c2_fix){
            ...
            if(d1_fix & d2_fix){
              ...
              results <- list(convergence_code = fittedModel$code, iterations = fittedModel$iterations, loglikelihood_value = -fittedModel$minimum, theta = fittedModel$estimate, gradient = fittedModel$gradient,
                              ...
                              est_C2 = C2,
                              est_C2_sd = est_sd[2 + nb1 + 2 + 1:nb2],
                              est_d2 = D2,
                              splines_degree = splines_degree, inner_knots1 = inner_knots1, inner_knots2 = inner_knots2)
              ...
              results <- list(convergence_code = fittedModel$code, iterations = fittedModel$iterations, loglikelihood_value = -fittedModel$minimum, theta = fittedModel$estimate, gradient = fittedModel$gradient,
                              ...
                              est_C2 = C2,
                              est_C2_sd = est_sd[2 + nb1 + 3 + 1:nb2],
                              est_d2 = D2,
          ...
          if(c1_fix & c2_fix){
            ...
            if(d1_fix & d2_fix){
              ...
              results <- list(convergence_code = fittedModel$code, iterations = fittedModel$iterations, loglikelihood_value = -fittedModel$minimum, theta = fittedModel$estimate, gradient = fittedModel$gradient,
                              ...
                              est_scale_horizontal = SCALE_HORIZONTAL,
                              est_scale_vertical = SCALE_VERTICAL,
                              est_scale_vertical_sd = est_sd[1],
                              est_a1 = A1,
                              est_b1 = B1,
                              est_C1 = C1,
                              est_d1 = D1,
          ...
          if(c1_fix & c2_fix){
            ...
            if(d1_fix & d2_fix){
              ...
              results <- list(convergence_code = fittedModel$code, iterations = fittedModel$iterations, loglikelihood_value = -fittedModel$minimum, theta = fittedModel$estimate, gradient = fittedModel$gradient,
                              ...
                              est_C2_sd = est_sd[3 + nb1 + 3 + 1:nb2],
                              est_d2 = D2,
                              est_d1_sd = est_sd[3 + nb1 + 3 + nb2 + 1],
                              splines_degree = splines_degree, inner_knots1 = inner_knots1, inner_knots2 = inner_knots2)
